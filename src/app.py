...
for subject in subjects:
    ...
    ].mean(axis=1).round(2)  # Round to 2 decimal places

# Calculate the final grade average across all subjects
df["Grade Average"] = df[[f"{subject}" for subject in subjects]].mean(axis=1).round(2)  # Round to 2 decimal places
...
app.layout = dbc.Container(
    [
        dbc.Row(
            [
                dbc.Col(
                    html.H1("High School Students' Grades Dashboard"), className="mb-4"
                )
            ]
        ),
        dbc.Row(
            [
                dbc.Col(
                    ...
                    width=4,
                    style={"margin-bottom": "0px"},  # Custom margin
                ),
                dbc.Col(
                    [
                        dbc.Card(
            ...
            className="align-items-start",  # Ensure top alignment
        ),
        dbc.Row(
            [
                dbc.Col(
                    ...
                    width=4,
                    style={"margin-top": "0px"},  # Custom margin
                )
            ]
        ),
        dbc.Row(
                ...
                dbc.Col(
                    dash_table.DataTable(
                        ...
                        columns=[
                            ...
                            {"name": "Matematica", "id": "Math"},
                            {"name": "Ciencia", "id": "Science"},
                            {"name": "Ingles", "id": "English"},
